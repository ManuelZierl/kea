...
use super::rendering::{terminal_font_metrics, uses_compact_chrome};
use super::{button, KeaView};
use gpui::{prelude::*, *};
use gpui_component::{
...
impl KeaView {
    pub(super) fn render_document(
        ...
        let line_height = f32::from(terminal_font_metrics(window, cx).line_height)
