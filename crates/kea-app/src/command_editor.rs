...
pub fn register_languages() {
    ...
    registry.register("bash", &LanguageConfig::new("Bash", tree_sitter_bash::LANGUAGE.into(), vec![], tree_sitter_bash::HIGHLIGHT_QUERY, "", ""));
    ...
    registry.register("text", &LanguageConfig::new("Plain text", tree_sitter_bash::LANGUAGE.into(), vec![], "", "", ""));
}
